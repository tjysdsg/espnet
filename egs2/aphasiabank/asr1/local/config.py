...
train_spks = train_english_pwa + train_english_control + train_french_pwa + train_french_control
val_spks = val_english_pwa + val_english_control + val_french_pwa + val_french_control
test_spks = test_english_pwa + test_english_control + test_french_pwa + test_french_control
...
english_spks = train_english_pwa + train_english_control + val_english_pwa + val_english_control \
               + test_english_pwa + test_english_control
french_spks = train_french_pwa + train_french_control + val_french_pwa + val_french_control \
              + test_french_pwa + test_french_control
pwa_spks = train_english_pwa + train_french_pwa + val_english_pwa + val_french_pwa + test_english_pwa + test_french_pwa
control_spks = train_english_control + train_french_control + val_english_control + val_french_control \
               + test_english_control + test_french_control
