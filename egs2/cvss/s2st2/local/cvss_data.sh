...
cvss_data_url=https://storage.googleapis.com/cvss/cvss_c_v1.0/cvss_${version}_${src_lang}_en_v1.0.tar.gz
...
if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
    ...
    log "Prepare source data from CVSS"
    mkdir -p ${CVSS}/es_en-c
    local/download_and_untar.sh ${CVSS} ${cvss_data_url} cvss_${version}_${src_lang}_en_v1.0.tar.gz
    mv ${CVSS}/train ${CVSS}/es_en-c
    mv ${CVSS}/test ${CVSS}/es_en-c
    mv ${CVSS}/dev ${CVSS}/es_en-c
    mv ${CVSS}/*.tsv ${CVSS}/es_en-c
fi
