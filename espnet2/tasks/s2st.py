...
from espnet2.asr.encoder.wav2vec2_encoder import FairSeqWav2Vec2Encoder, FairSeqWav2Vec2EncoderWithAdapter
...
encoder_choices = ClassChoices(
    ...
    classes=dict(
        ...
        wav2vec2_with_adaptor=FairSeqWav2Vec2EncoderWithAdapter,
