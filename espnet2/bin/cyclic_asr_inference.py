...
class Speech2Text:
    ...
    Examples:
        >>> import soundfile
        >>> speech2text = Speech2Text("config.yml", "cyclic.pth")
    ...
    def __init__(
        self,
        cyclic_train_config: Union[Path, str] = None,
        cyclic_model_file: Union[Path, str] = None,
        ...
        penalty: float = 0.0,
        nbest: int = 1,
        cyclic_greedy: bool = False,
    ):
        assert check_argument_types()

        # 1. Build ASR model
        scorers = {}
        cyclic_model, cyclic_train_args = TTSTask.build_model_from_file(
            cyclic_train_config, cyclic_model_file, device
        )
        ...
        self.dtype = dtype
        self.nbest = nbest
        self.cyclic_greedy = cyclic_greedy
...
def inference(
        ...
        cyclic_train_config: Optional[str],
        cyclic_model_file: Optional[str],
    ...
    speech2text_kwargs = dict(
        cyclic_train_config=cyclic_train_config,
        cyclic_model_file=cyclic_model_file,
    ...
    loader = ASRTask.build_streaming_iterator(
        ...
        preprocess_fn=ASRTask.build_preprocess_fn(speech2text.cyclic_train_args, False),
        collate_fn=ASRTask.build_collate_fn(speech2text.cyclic_train_args, False),
...
def get_parser():
    parser = config_argparse.ArgumentParser(
        description="Cyclic ASR Decoding",
    ...
    group.add_argument("--cyclic_greedy", type=str2bool, default=False)

    group = parser.add_argument_group("The model configuration related")
    group.add_argument(
        "--cyclic_train_config",
        type=str,
        help="Cyclic training configuration",
    )
    group.add_argument(
        "--cyclic_model_file",
        type=str,
        help="Cyclic model parameter file",
    )
    group.add_argument(
        "--lm_train_config",
        type=str,
